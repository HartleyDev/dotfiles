...
alias tree="tree -C"
alias zend="vi scp://sjc-dev-usrv163/"
...
# Exports {{{
export GITHUB_USER="hartleyShawn"
...
# Alias' {{{
alias vi="/Applications/MacVim.app/Contents/MacOS/vim -f -g "
...
<%{$fg_bold[magenta]%}<branch>%{$reset_color%}>" 2>/dev/null
}
...
PROMPT='
${PR_GREEN}%{$reset_color%} ${PR_BOLD_YELLOW}$(current_pwd)%{$reset_color%} $(hg_prompt_info)$(git_prompt_string)
$(prompt_char) '

# export SPROMPT="Correct $fg[red]%R$reset_color to $fg[green]%r$reset_color [(y)es (n)o (a)bort (e)dit]? "

# RPROMPT='${PR_GREEN}$(virtualenv_info)%{$reset_color%} ${PR_GREEN}%n@%m%{$reset_color%} '
# }}}
